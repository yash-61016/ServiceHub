...
public class SP_Booking extends AppCompatActivity implements View.OnClickListener {
...
private LinearLayout review, call, message, directions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_p__booking);
        ...
        final String category = getIntent().getStringExtra("skills");
        ...
        spemailid = getIntent().getStringExtra("emailID");
        final String currentid = ServiceProviderMainScreen.decodeUserEmail(fuser.getEmail());
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(currentid.equals(requestBox.getSender()) && spemailid.equals(requestBox.getReceiver()) &&
    ...
    private void showRatingDialog() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(SP_Booking.this);
        ...
        EditText comment = (EditText)mView.findViewById(R.id.comment);
        ...
        submit.setOnClickListener(view -> {
            spemailid = getIntent().getStringExtra("emailID");
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("ServiceProviders").child("Details").child(ServiceProviderMainScreen.decodeUserEmail(spemailid));
            numRate++;
            ...
            databaseReference.child("Review").setValue(comment.getText().toString());
        ...
        rbar.setOnRatingBarChangeListener((ratingBar, v, b) -> {
            int V = (int) v;
            if (V == 1)
    ...
    private void showRequestDialog()
    {
        ...
        send.setOnClickListener(v -> {
            ...
            if(!datetext.equals("") && !timetext.equals("") && !destext.equals("")){
                Toast.makeText(SP_Booking.this,"Request Sent",Toast.LENGTH_SHORT).show();
                sendMessage(ServiceProviderMainScreen.decodeUserEmail(fuser.getEmail()),ServiceProviderMainScreen.decodeUserEmail(spemailid),datetext,timetext,destext,status);
                ...
                Toast.makeText(SP_Booking.this,"Fill out all the fields",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(SP_Booking.this,
        ...
        time.setOnClickListener(v -> {
            ...
            TimePickerDialog timePickerDialog = new TimePickerDialog(SP_Booking.this,
                    AlertDialog.THEME_HOLO_DARK,
                    onTimeSetListener,
                    hour,min,false);
    ...
    private void showPayDialog() {
        ...
        cash.setOnClickListener(view -> {
            Toast.makeText(SP_Booking.this, "Cash mode selected", Toast.LENGTH_LONG).show();
            dialog.cancel();
        });
    }
    ...
    public void onClick(View view) {
        ...
        {   Bundle b = getIntent().getExtras();
            Intent intent = new Intent(SP_Booking.this, MapDirections.class);
            intent.putExtras(b);
            startActivity(intent);
        }
        if(view == message)
    ...
    public void sendMessage(String sender, String receiver, String datetext, String timetext, String destext, String status){
        ...
        chatRef1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists())
                {
                    chatRef1.child("id").setValue(ServiceProviderMainScreen.decodeUserEmail(fuser.getEmail()));
