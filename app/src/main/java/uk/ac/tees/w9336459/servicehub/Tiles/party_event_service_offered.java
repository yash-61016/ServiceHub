...
public class party_event_service_offered extends AppCompatActivity {
    ...
    private void ChangeRecyclerView(String service) {
        ...
        FirebaseRecyclerAdapter<ServiceProviders, party_event_service_offered.ServiceProviderViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<ServiceProviders, party_event_service_offered.ServiceProviderViewHolder>(

                ServiceProviders.class,
                R.layout.list_layout,
                party_event_service_offered.ServiceProviderViewHolder.class,
                fbq

        ) {
            @Override
            protected void populateViewHolder(party_event_service_offered.ServiceProviderViewHolder usersViewHolder, ServiceProviders users, int i) {
