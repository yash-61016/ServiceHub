...
import uk.ac.tees.w9336459.servicehub.Model.MessageAdapter;
...
public class Chat extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Customers").child(userid);
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    readMessage(U_MainScreen.decodeUserEmail(firebaseUser.getEmail()),userid,null);
                }
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    readMessage(ServiceProviderMainScreen.decodeUserEmail(firebaseUser.getEmail()),userid,s.getProfilepicture());
                }
    ...
    private void sendMessage(String sender, String receiver, String message){
        ...
        final DatabaseReference dataref = FirebaseDatabase.getInstance().getReference("Chatlist")
                .child(U_MainScreen.decodeUserEmail(firebaseUser.getEmail()))
                .child(userid);
