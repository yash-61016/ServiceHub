...
import static uk.ac.tees.w9336459.servicehub.ServiceProviderNewAccount.encodeUserEmail;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ServiceProviders2 sp = new ServiceProviders2(firstname,lastname,emailid,phonenum,experience,description,skills,SPaddress);
                sp.setProfilepicture(downloadUrlPP);
                sp.setLatitude(position.latitude);
                sp.setLongitude(position.longitude);
                String EmailChildID = encodeUserEmail(emailid);
                FirebaseDatabase.getInstance().getReference("ServiceProviders")
                        .child("Details").child(EmailChildID)
                        .setValue(sp).addOnCompleteListener(task -> {
                            if (task.isSuccessful()) {
                                Toast.makeText(asklocationSP.this, "Registered Successfully", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(asklocationSP.this, ServiceProviderLogin2.class);
                                intent.putExtra("downloadUrlPP",downloadUrlPP.toString());
